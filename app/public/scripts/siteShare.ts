...
                'CoNET加密货币钱包和交易所'
        ...
        imapInformation: {
            ...
            tempImapAccount: `Have problem with your IMAP enabled email account? <a href="#" style = "margin-left: 0.5em;" class="ui label teal" onclick="return linkClick ('https://github.com/QTGate/QTGate-Desktop-Client/wiki/iCloud-temporary-account')"> Get temporary account.</a>`,
